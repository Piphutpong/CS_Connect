(() => {
  ...
  const JOB_STATUS_TONE = {
    ...
    "ผมต. ตีกลับ": "danger",
    // ขอขยายเขตระบบจำหน่ายไฟฟ้า -- ลูกค้ากลุ่มนี้ก็ได้ QR ไปติดตามสถานะเองเหมือน
    // กัน ชุดสถานะจึงต้องอยู่ที่นี่ด้วย ไม่งั้นจะขึ้นสีเทากลาง ๆ ทุกสถานะ
    // (สำเนาของ app.js -- ไม่มีขั้นตอน build ให้แชร์ไฟล์กัน แก้ที่ไหนต้องแก้อีกที่)
    "รอจ่ายงาน": "warning",
    "รอสำรวจ": "warning",
    "รอเขียนผัง": "warning",
    "รอประมาณการ": "warning",
